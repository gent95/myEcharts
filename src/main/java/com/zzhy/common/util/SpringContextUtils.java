...
public class SpringContextUtils implements ApplicationContextAware {
	...
	public static void registerBean(Class clz,String name){
		ConfigurableApplicationContext configApplicationContext = (ConfigurableApplicationContext)applicationContext;
		DefaultListableBeanFactory beanFactory = (DefaultListableBeanFactory) configApplicationContext.getBeanFactory();
